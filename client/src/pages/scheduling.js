...
import { Container, Form, FloatingLabel, Button, Row , Col, Alert} from "react-bootstrap";
      ...
      <Form>
        <Row>
          <Col xs={12} md={6}>
            <FloatingLabel controlId="floatingInput1" label="First Name *" className="mb-3">
              <Form.Control type="text" placeholder="Name" onChange={handleFName} />
            </FloatingLabel>
          </Col>

          <Col xs={12} md={6}>
            <FloatingLabel controlId="floatingInput2" label="Last Name *" className="mb-3">
              <Form.Control type="text" placeholder="Name" onChange={handleLastName}/>
            </FloatingLabel>
          </Col>
        </Row>
        <br />
        <Row>
          ...
          <Col xs={12} md={6}>
            <FloatingLabel controlId="floatingInput4" label="Phone *" className="mb-3">
              <Form.Control type="number" placeholder="XXXXXXXX" onChange={handlePhone}/>
            </FloatingLabel>
          </Col>
        </Row>
        <br />

        <FloatingLabel controlId="floatingInput5" label="Selected Package *" className="mb-3">
          <Form.Control type="text" readOnly value={service + ", $" + price}>
        ...
        <Row>
          <Col xs={12} md={6}>
            ...
            <br />
            <input type="date" className="form-control" id="dateBooking" name="dateBooking" onChange={handleDateBooking}/>
          </Col>

          <Col xs={12} md={6}>
            <label htmlFor="timeBooking">Time</label>
            <br />
            <input type="time" className="form-control" id="timeBooking" name="timeBooking" onChange={handleTimeBooking}/>
          </Col>
        </Row>
        <br />

        <FloatingLabel controlId="floatingInput6" label="Address *" className="mb-3">
        ...
        <Row>
          ...
          <Col xs={12} md={6}>
            <FloatingLabel controlId="floatingInput9" label="Postal Code *" className="mb-3">
              <Form.Control type="text" placeholder="XXXXXXXX" onChange={handlePostalCode}/>
            </FloatingLabel>
          </Col>
        </Row>
