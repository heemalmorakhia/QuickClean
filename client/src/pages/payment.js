import { Container, Form, FloatingLabel, Button, Row , Col, Placeholder, Alert} from "react-bootstrap";
...
function Payment(props)
{
    ...
    if(cardholdNameRegex.test(cardHolderName))
    {
        ...
        document.querySelector("#cardHolderName-fill").style.borderColor = "#f5120a";
    }
    ...
    return(
        <PageLayout>
            ...
            <p>
            Please check that the information you filled in is correct!
            </p>
            <hr />
        ...
        <div className="d-flex justify-content-center">
            <hr style={{ borderTop: '5px solid #999', width: '70%', textAlign: 'center' }} />
        </div>
            <Container style={{padding: "50px", paddingTop : "40px", paddingBottom: "30px"}}>
                ...
                <Row>
                    ...
                    <Col md={6}>
                        <div className="container mt-4">
                            ...
                            <div className="col-md-9" style={{ border: '2px solid grey',borderRadius: '10px', marginBottom: '20px', display: 'inline-block'}}>
                                <form onSubmit={handleSubmit} style={{padding: '10px'}}> 
                                <div className="form-group">
                                    <label htmlFor="cardNumber">Card Number <span style={{ fontSize: '10px', color: 'grey', display: 'inline' }}> [Visa OR Debit OR Master]</span> </label>
                                    <input
                                    type="text"
                                ...
                                <div className="form-row">
                                    ...
                                    <label htmlFor="expirationMonth">Expiration</label>
                                        ...
                                        />
                                     <p style={{ fontSize: '10px', color: 'grey', display: 'inline' }}>* What is the expiry date</p>
                                     <p style={{ fontSize: '10px', color: 'grey' }}>* It is formatted as MM/YY</p>
                                  </Col>
                                    ...
                                    <Col className="form-group col-md-6">
                                        ...
                                        />
                                         <p style={{ fontSize: '10px', color: 'grey', display: 'inline' }}>* Card Verification Number</p>
                                        <p style={{ fontSize: '10px', color: 'grey' }}>* It is three- or four-digit number</p>
                                    </Col>
            ...
            {show && <Alert variant="success" style={{
                    color: 'white',
                    textAlign: 'center',
                    width: '40%',
                    borderRadius: '8px',
                ...
                <p>
                Thanks for booking our cleaning service!
                </p>
            </Alert>
            }
        </PageLayout>
